...
- Clone the repository:
  ...
  ```sh
  git clone https://github.com/SplaatSites/rayman-3.git
  ```

- Copy your game's disc image to `orig/GRHE41`.
...
- Configure:
  ...
  To use a version other than `GRHE41` (USA), specify it with `--version`.
